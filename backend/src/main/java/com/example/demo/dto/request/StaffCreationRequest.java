...
public class StaffCreationRequest {
  ...
  @Valid // Quan trọng để validate các trường bên trong từng bản ghi lương
  private List<SalaryCreationRequest> salaries;

  public List<SalaryCreationRequest> getSalaries() {
    return salaries;
  }

  public void setSalaries(List<SalaryCreationRequest> salaries) {
